...
     <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        {/* Chuyển thành 1 cột trên mobile, 2 trên tablet và 4 trên desktop */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="p-4 flex items-center gap-3">
              {/* Sửa icon: Dùng MapPin cho địa điểm */}
          ...
          <Card>
            <CardContent className="p-4 flex items-center gap-3">
              {/* Sửa icon: Dùng ShieldCheck cho trạng thái */}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <div className="overflow-x-auto pb-2">
          <TabsList className="grid w-full min-w-max grid-cols-7">
            {/* Thay đổi icon cho đúng ngữ nghĩa hơn */}
