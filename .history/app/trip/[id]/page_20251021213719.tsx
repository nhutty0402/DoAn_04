                        ...
                        <Card className="h-full min-h-[120px]">
                            <CardContent className="p-4 flex flex-col justify-between h-full">
                                ...
                                <div className="flex justify-end mt-2">
                                    <button aria-label="Copy thời gian" className="p-1 rounded hover:bg-muted" onClick={() => handleCopy('time', trip.ngay_bat_dau && trip.ngay_ket_thuc ? `${new Date(trip.ngay_bat_dau).toLocaleDateString("vi-VN")} - ${new Date(trip.ngay_ket_thuc).toLocaleDateString("vi-VN")}` : '')}>
                            ...
                            <CardContent className="p-4 flex flex-col justify-between h-full">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="font-semibold text-sm truncate">{trip.dia_diem_xuat_phat || "Chưa cập nhật"}</p>
                                    </div>
                                </div>
                                <div className="flex justify-end mt-2">
                            ...
                            <CardContent className="p-4 flex flex-col justify-between h-full">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="font-semibold text-sm truncate">{trip.tien_te || "VNĐ"}</p>
                                    </div>
                                </div>
                                <div className="flex justify-end mt-2">
                            ...
                            <CardContent className="p-4 flex flex-col justify-between h-full">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="font-semibold text-sm truncate">{trip.cong_khai ? "Công khai" : "Riêng tư"}</p>
                                    </div>
                                </div>
                                <div className="flex justify-end mt-2">
