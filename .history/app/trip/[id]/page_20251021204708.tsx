...
          {/* 4 CỘT */}
      {/* Thay đổi: grid-cols-1 trên mobile, md:grid-cols-2 trên desktop cho cân đối */}
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  {/* Card Thời gian */}
  <Card>
    <CardContent className="p-4">
      <div className="flex items-center gap-3"> {/* Tăng gap lên một chút */}
        <Calendar className="h-5 w-5 text-primary" /> {/* Icon lớn hơn một chút */}
        <div>
  ...
  <Card>
    <CardContent className="p-4">
      <div className="flex items-center gap-3">
        {/* Sửa icon: Dùng ShieldCheck cho trạng thái (an toàn, công khai) */}
