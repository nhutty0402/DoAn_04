...
          {/* 4 CỘT */}
        {/* Thay đổi layout: 1 cột trên mobile, 2 cột trên desktop cho cân đối và dễ đọc hơn */}
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  {/* Card 1: Thời gian */}
  <Card>
    <CardContent className="p-4">
      <div className="flex items-center gap-3"> {/* Tăng nhẹ khoảng cách */}
        <Calendar className="h-5 w-5 text-primary" /> {/* Tăng nhẹ kích thước icon */}
        <div>
          ...
          <p className="font-semibold">
            {trip.ngay_bat_dau && trip.ngay_ket_thuc
              ? `${new Date(trip.ngay_bat_dau).toLocaleDateString(
                  "vi-VN"
                )} - ${new Date(trip.ngay_ket_thuc).toLocaleDateString("vi-VN")}`
              : "Chưa cập nhật"}
          </p>
        </div>
      </div>
  ...
  {/* Card 2: Địa điểm xuất phát */}
  <Card>
    <CardContent className="p-4">
      <div className="flex items-center gap-3">
        {/* Sửa icon: Dùng MapPin cho địa điểm, đúng ngữ nghĩa hơn */}
  ...
  <Card>
    <CardContent className="p-4">
      <div className="flex items-center gap-3">
        {/* Sửa icon: Dùng DollarSign cho tiền tệ */}
  ...
  <Card>
    <CardContent className="p-4">
      <div className="flex items-center gap-3">
        {/* Sửa icon: Dùng ShieldCheck cho trạng thái (công khai/riêng tư) */}
