  ...
  useEffect(() => {
    const fetchDays = async () => {
      ...
      if (!token || token === "null" || token === "undefined") {
        // No token: keep mock data as a graceful fallback
        console.warn("No token found when fetching itinerary days; using mock data")
      ...
      try {
        // Try to fetch days for this tripId
        ...
        console.error("Failed to fetch itinerary days:", error)
        toast({
