...
// <-- 1. THÊM ngayBatDau VÀ ngayKetThuc VÀO PROPS -->
interface ItineraryTabProps {
  tripId: string
  ngayBatDau: string // <-- THÊM DÒNG NÀY (Định dạng YYYY-MM-DD)
  ngayKetThuc: string // <-- THÊM DÒNG NÀY (Định dạng YYYY-MM-DD)
}

// <-- 2. NHẬN PROPS MỚI VÀO COMPONENT -->
export function ItineraryTab({ tripId, ngayBatDau, ngayKetThuc }: ItineraryTabProps) {
  ...
  // <-- 3. CẬP NHẬT HÀM handleAddDay VỚI LOGIC KIỂM TRA NGÀY -->
  const handleAddDay = async (dayData: any) => {
    ...
    // ================================================================
    // <-- PHẦN JS THÔNG BÁO BẮT LỖI NGÀY BẮT ĐẦU TỪ ĐÂY -->
    // ================================================================

    const newDateStr = dayData.ngay // Ngày người dùng mới chọn (ví dụ: "2024-10-25")
    ...
    // Thêm 'T00:00:00' để đảm bảo so sánh đúng ngày, tránh lệch múi giờ.
    ...
    // Lỗi 3: Trùng ngày đã có (kiểm tra phía client)
    ...
    try {
      ...
      // <-- 4. THÊM BẮT LỖI 409 (CONFLICT) TỪ SERVER -->
    ...
    <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-sm text-muted-foreground">
                              {/* Thêm T00:00:00 để tránh lỗi múi giờ hiển thị sai ngày */}
      ...
      {editingDay && (
        <EditDayModal
          ...
          onSubmit={(dayData) => {
            // LƯU Ý: Bạn cũng nên thêm validation ngày cho cả hàm SỬA ở đây
