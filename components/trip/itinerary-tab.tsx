...
export function ItineraryTab({ tripId }: ItineraryTabProps) {
  ...
  const handleAddDay = (dayData: any) => {
    const newDay = {
      id: `day${Date.now()}`,
      ...dayData,
      pois: [],
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground font-[family-name:var(--font-dm-sans)]">
            Quản lý các ngày và điểm đến trong chuyến đi
          </p>
        </div>
      ...
      {/* Modals */}
      {showAddDayModal && <AddDayModal onClose={() => setShowAddDayModal(false)} onSubmit={handleAddDay} />}
