  ...
  const searchHotels = async (diaDiem: string) => {
    ...
    try {
      ...
      const resp = await axios.get(
        "https://travel-planner-imdw.onrender.com/api/khach-san/tim",
        {
          params: { 
      ...
      const danhSach = resp.data?.danh_sach || []
      ...
      toast({
        ...
        description: resp.data?.message || `Tìm thấy ${danhSach.length} khách sạn`,
      })
    } catch (err: any) {
